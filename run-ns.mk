...
TARGET_MPI_ONE2=ib_write_bw -d nex0 -a -n 2000 -p 20001 10.1.2.1

# TARGET_MPI_ONE1=ib_write_lat -d nex0 -a -n 5

# TARGET_MPI_ONE2=ib_write_lat -d nex0  -a -n 5 10.1.2.1
